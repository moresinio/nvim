return {
	...
	config = function()
		require('smoothcursor').setup({
			...
			cursor = "󱨉", -- Cursor shape (requires Nerd Font). Disabled in fancy mode.
			...
			disabled_filetypes = { "lazy", "themify", }, -- Disable for these file types, ignored if enabled_filetypes is set. e.g., { "TelescopePrompt", "NvimTree" }
